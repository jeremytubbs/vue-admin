...
},{"../components/editor":86,"./content-editor.template.html":95}],95:[function(require,module,exports){
module.exports = '<h1>Editor</h1>\n<div v-show="!params.contents.response"><br>Loading...</div>\n<editor v-if="params.contents.response" params="{{params}}"></editor>';
